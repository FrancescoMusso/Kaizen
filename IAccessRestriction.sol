...
interface IAccessRestriction is IAccessControlUpgradeable {
    ...
    /**
     * @dev check if given address is Kaizen contract
     * @param _address input address
     */
    function ifKaizenContract(address _address) external view;

    /**
     * @dev check if given address has Kaizen contract role
     * @param _address input address
     * @return if given address has Kaizen contract role
     */
    function isKaizenContract(address _address) external view returns (bool);
    ...
    /**
     * @dev check if given address is DataManager or Kaizen contract
     * @param _address input address
     */
    function ifDataManagerOrKaizenContract(address _address) external view;
